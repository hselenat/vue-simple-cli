...
_commander.program.command('init').description('初始化项目').option('-r, --react', '初始化react项目').option('-v, --vue', '初始化vue项目').option('-t, --typescript', '初始化typescript项目').action(function (args) {
